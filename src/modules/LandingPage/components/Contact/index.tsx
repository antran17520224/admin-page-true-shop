...
const Contact = () => {
	...
	return (
		<div className="wrapper-contact" id="contact">
			<Row>
				<Col xxl={12} xl={12} lg={12} md={24} sm={24} xs={24} className="wrapper-info-true-shop">
					<span className="subtitle">{t('_contact_us')}</span>
					<Title level={3}>{t('_get_in_touch')}</Title>
				...
				<Col xxl={12} xl={12} lg={12} md={24} sm={24} xs={24} className="wrapper-maps d-flex">
					<div className="maps">
						<iframe
